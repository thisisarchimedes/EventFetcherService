...
export interface PositionCloserInterface extends utils.Interface {
  functions: {
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "closePosition((uint256,uint256,uint8,bytes,address))": FunctionFragment;
  ...
  events: {
    ...
    "PositionClosed(uint256,address,uint256,uint256)": EventFragment;
