...
export interface AuraStablePoolAdapterInterface extends utils.Interface {
  functions: {
...
export interface AuraStablePoolAdapter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AuraStablePoolAdapterInterface;
