...
export interface PositionLiquidatorInterface extends utils.Interface {
  functions: {
    ...
    "liquidatePosition((uint256,uint256,uint8,bytes,address))": FunctionFragment;
  ...
  events: {
    ...
    "PositionLiquidated(uint256,address,uint256,uint256,uint256)": EventFragment;
...
export interface PositionLiquidator extends BaseContract {
  ...
  filters: {
    ...
    "PositionLiquidated(uint256,address,uint256,uint256,uint256)"(
